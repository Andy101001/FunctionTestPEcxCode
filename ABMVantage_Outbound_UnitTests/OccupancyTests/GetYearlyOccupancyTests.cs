...
{
    public class GetYearlyOccupancyTests
    {
        ...
        public GetYearlyOccupancyTests()
        {
        ...
        [Fact]
        public async Task GetYearlyOccupancyTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetYearlyOccupancyTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

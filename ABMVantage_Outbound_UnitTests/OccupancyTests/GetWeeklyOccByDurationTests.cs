...
{
    public class GetWeeklyOccByDurationTests
    {
        ...
        public GetWeeklyOccByDurationTests()
        {
        ...
        [Fact]
        public async Task GetWeeklyOccByDurationTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetWeeklyOccByDurationTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

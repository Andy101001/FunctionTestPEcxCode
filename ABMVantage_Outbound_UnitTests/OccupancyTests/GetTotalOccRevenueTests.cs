...
{
    public class GetTotalOccRevenueTests
    {
        ...
        public GetTotalOccRevenueTests()
        {
        ...
        [Fact]
        public async Task GetTotalOccRevenueTests_Sucess()
        {
        ...
        [Fact]
        public async Task GetTotalOccRevenueTests_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

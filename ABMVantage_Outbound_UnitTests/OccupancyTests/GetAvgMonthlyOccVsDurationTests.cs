...
namespace ABMVantage_Outbound_UnitTests.OccpancyTests
{
    public class GetAvgMonthlyOccVsDurationTests
    {
        ...
        public GetAvgMonthlyOccVsDurationTests()
        {
        ...
        [Fact]
        public async Task GetAvgMonthlyOccVsDurationTests_Sucess()
        {
        ...
        [Fact]
        public async Task GetAvgMonthlyOccVsDurationTests_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

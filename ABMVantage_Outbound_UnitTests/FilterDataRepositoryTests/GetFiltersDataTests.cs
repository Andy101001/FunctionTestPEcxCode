namespace ABMVantage_Outbound_UnitTests.FilterDataRepositoryTests
{
    ...
    public class GetFiltersDataTests
    {
        ...
        [Fact]
        public async Task GetFiltersDataTests_Sucess()
        {
        ...
        [Fact]
        public async Task GetFiltersDataTests_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

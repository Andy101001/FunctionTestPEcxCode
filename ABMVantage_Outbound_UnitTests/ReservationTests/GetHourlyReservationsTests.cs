...
{
    public class GetHourlyReservationsTests
    {
        ...
        public GetHourlyReservationsTests()
        {
        ...
        [Fact]
        public async Task GetHourlyReservationsTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetHourlyReservationsTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

...
{
    public class GetDailyReservationsTests
    {
        ...
        public GetDailyReservationsTests()
        {
        ...
        [Fact]
        public async Task GetDailyReservationsTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetDailyReservationsTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

...
{
    public class GetTransactionMonthsTests
    {
        ...
        public GetTransactionMonthsTests()
        {
        ...
        [Fact]
        public async Task GetTransactionMonthsTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetTransactionMonthsTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

...
{
    public class GetTranactionByHoursTests
    {
        ...
        public GetTranactionByHoursTests()
        {
        ...
        [Fact]
        public async Task GetTranactionByHoursTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetTranactionByHoursTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

...
{
    public class GetBudgetVsActualVarianceTests
    {
        ...
        public GetBudgetVsActualVarianceTests()
        {
        ...
        [Fact]
        public async Task GetBudgetVsActualVarianceTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetBudgetVsActualVarianceTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

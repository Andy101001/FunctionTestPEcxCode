...
{
    public class GetRevenueByProductByDaysTests
    {
        ...
        public GetRevenueByProductByDaysTests()
        {
        ...
        [Fact]
        public async Task GetRevenueByProductByDaysTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetRevenueByProductByDaysTest_Failure()
        {

...
{
    public class GetRevenueByDaysTests
    {
        ...
        [Fact]
        public async Task GetRevenueByDaysTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetRevenueByDaysTest_Failure()
        {

...
{
    public class GetTransactionByDaysTests
    {
        ...
        public GetTransactionByDaysTests()
        {
        ...
        [Fact]
        public async Task GetTransactionByDaysTest_Sucess()
        {
        ...
        [Fact]
        public async Task GetTransactionByDaysTest_Failure()
        {
            var mockLogger = new Mock<ILogger<Transaction_NewService>>();
            mockLogger.Setup(
                m => m.Log(

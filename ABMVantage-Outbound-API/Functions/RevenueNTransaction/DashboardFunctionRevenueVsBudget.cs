...
namespace ABMVantage_Outbound_API.Functions.RevenueNTransaction
{
    public class DashboardFunctionRevenueVsBudget
    {
        ...
        public DashboardFunctionRevenueVsBudget(ILoggerFactory loggerFactory, IOccupancyService occupancyService)
        {
        ...
        [OpenApiOperation(operationId: "GetYearlyOccupancy", tags: new[] { "ABM Dashboard" }, Summary = "Get Revenue VS Budget", Description = "")]

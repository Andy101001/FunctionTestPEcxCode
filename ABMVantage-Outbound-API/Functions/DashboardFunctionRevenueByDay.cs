...
namespace ABMVantage_Outbound_API.Functions
{
    public class DashboardFunctionRevenueByDay
    {
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "getrevenuebyday")] HttpRequestData reg, [FromQuery] DateTime calculationDate, [FromQuery] string? facilityId, [FromQuery] string? levelId, [FromQuery] string? parkingProductId)
        {
